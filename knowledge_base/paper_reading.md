...
### 2026/07/21 - TDRec: Beyond Static Diffusion — 显式建模时间模式
...
### 2026/07/21 - M3BSR：多模态多行为条件扩散特征去噪
...
### 2026/07/21 - InDiRec：意图感知扩散 + 对比学习
...
### 2026/07/21 - LSGM4Rec：LLM 增强的引导扩散多模态序列推荐
...
### 2026/07/21 - HorizonRec：Align-for-Fusion — 三重偏好双导向扩散
...
### 2026/07/21 - FatsMB：从 agnostic 到 specific — 潜偏好扩散（arXiv 2026）
...
### 2026/07/21 - AuxDiff：辅助信息挖掘-探索 + 高效采样增强扩散推荐
...
### 2026/07/21 - GlobalDiff：全局扩散增强序列推荐
...
4. 在 Beauty, Sports, Toys, Yelp 四个数据集上与其他方法进行比较，大多提升约 3%，面对极度稀疏序列（数据量<5）时提升约 10%。
...
### 2026/07/21 - DiQDiff：扩散序列推荐的非同质化量化引导
